...
class StokController extends Controller
{
    ...
    {
        $request->validate([
            'stok_tanggal' => 'required|datetime_local',    // stok_tanggal harus diisi dan berupa datetime
            'stok_jumlah' => 'required|integer|min:0',         // stok_jumlah harus diisi dan berupa angka
            'barang_id' => 'required|integer|unique:t_stok,barang_id',         // barang_jual harus diisi dan berupa angka
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            'stok_tanggal' => 'required|datetime_local',    // stok_tanggal harus diisi dan berupa datetime
            'stok_jumlah' => 'required|integer|min:0',         // stok_jumlah harus diisi dan berupa angka
            'barang_id' => 'required|integer|unique:t_stok,barang_id,'.$id.',barang_id',         // barang_jual harus diisi dan berupa angka
            'user_id' => 'required|integer'        // user_id harus diisi dan berupa angka
        ]);
