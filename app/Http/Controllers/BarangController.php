...
class BarangController extends Controller
{
    ...
    {
        $request->validate([
            'barang_kode' => 'required|string|min:3|unique:m_barang,barang_kode', // barang_kode harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_barang kolom barang_kode
    ...
    {
        $request->validate([
            'barang_kode' => 'required|string|min:3|unique:m_barang,barang_kode,'.$id.',barang_id', // barang_kode harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_barang kolom barang_kode kecuali untuk barang dengan id yang sedang diedit
            'barang_nama' => 'required|string|max:100',    // barang_nama harus diisi, berupa string, dan maksimal 100 karakter
            'harga_beli' => 'required|integer',         // harga_beli harus diisi dan berupa angka
            'harga_jual' => 'required|integer',         // harga_jual harus diisi dan berupa angka
            'kategori_id' => 'required|integer'        // kategori_id harus diisi dan berupa angka
